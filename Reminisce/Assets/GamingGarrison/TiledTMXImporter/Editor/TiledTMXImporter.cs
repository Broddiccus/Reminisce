...
{    
    public class TiledTMXImporter
    {
        ...
        public static bool ImportTMXFile(string path, string inTilesetDir, Grid targetGrid, string inImageLayerSpriteDir, bool setHiddenLayersToInactive, bool forceGridColliders, bool useCompositeColliders)
        {
