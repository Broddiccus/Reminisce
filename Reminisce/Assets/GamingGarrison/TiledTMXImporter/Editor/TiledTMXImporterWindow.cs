...
namespace GamingGarrison
{
    public class TiledTMXImporterWindow : EditorWindow
    {
        ...
        void DoImport()
        {
            ...
            bool success = TiledTMXImporter.ImportTMXFile(m_sourcePath, relativeTilesetDir, m_targetGrid, imageLayerSpriteDir, m_setHiddenLayersToInactive, m_forceGridColliders, m_useCompositeColliders);
            if (success)
            {
